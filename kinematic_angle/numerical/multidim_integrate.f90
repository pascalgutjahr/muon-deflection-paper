...
! Alexander Sandrock: Added OpenMP parallelisation and made dcuhre the only
! public routine
...
INTEGER            :: num, keyf
INTEGER, PARAMETER :: mdiv=2, maxdim=15
...
!   Apply basic rule.
!$OMP PARALLEL DO PRIVATE(INDEX) DEFAULT(SHARED)
  DO i = 1, 2*ndiv
    INDEX = sbrgns + i
