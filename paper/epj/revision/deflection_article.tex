...
MUSIC \cite{MUSIC} and \pascaledit{\textsc{Geant4}} \cite{GEANT4} and data from two experiments in section~\ref{sec:accum_defl}. The findings of this study
...
Furthermore, there are parametrizations for stochastic deflections given in \pascaledit{\textsc{Geant4}} \cite{GEANT4} 
...
the tools MUSIC \cite{MUSIC,comparison_MUSIC_GEANT4_2009} and \pascaledit{\textsc{Geant4}} \cite{GEANT4}.
...
\begin{figure*}
    ...
    Van Ginneken (vG) or as in \pascaledit{\textsc{Geant4}}. Both scattering methods are checked. 
