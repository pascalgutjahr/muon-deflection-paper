...
\pascaledit{Typically, energy cuts of $v_{\mathrm{cut}} = \num{0.05}$ and 
...
\pascaledit{Also a simulation with \textsc{Geant4} $\text{v}11.0.3$ using the 
default settings is performed. At angles larger than $\SI{0.2}{\degree}$, 
\textsc{Geant4} simulates less large deflections than PROPOSAL and 
less than expected in the data. Similar to the comparison by Attwood, 
