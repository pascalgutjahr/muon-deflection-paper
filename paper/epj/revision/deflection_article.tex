...
\pascaledit{Typically, a relative energy cut of $v_{\mathrm{cut}} \leq \num{0.05}$ 
...
\pascalreplace{as Alameddine et al}{\cite{alameddine_et_al}}.
...
\subsection{Comparison with MUSIC and \pascaledit{\sc{Geant4}}}
...
these two tools. \pascaledit{Hence, the mean 
...
\pascaledit{This energy is obtained} via the energy-momentum relation of 
\pascaledit{a beam momentum of $p = \SI[per-mode=symbol]{168.9}{\mega\electronvolt\per\clight}$
...
\pascaledit{Even though in the logarithmic figure the simulation data agree well 
...
\begin{figure*}
    ...
    $v_{\mathrm{cut}} = \num{e-5}$. The blue points present the mean \pascaledit{of the simulations} considering
    stochastic deflections and Molière scattering \pascaledit{(MSM)}, the orange 
    points
    present the mean \pascaledit{of the simulations} taking into account only Molière scattering.   
...
\begin{figure*}
    ...
    copper layer. \pascaledit{In PROPOSAL} the energy cut 
