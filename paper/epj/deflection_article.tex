...
\abstract{
  ...
  with a $\SI{95}{\percent}$ central interval of $[\SI{0.02}{\degree}, \,\SI{0.27}{\degree}]$. 
...
in Ref.~\cite{KM3NeT_Resolution2021}. Hence, a rescaling to the muon energy is applied using the average energy transfer of the neutrino to 
