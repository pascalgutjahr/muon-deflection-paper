...
%
\institute{Dept. of Physics, TU Dortmund University, Otto-Hahn-Straße~4, Dortmund 44227, Germany \and 
...
\cite{IceCube_Instrumentation} or KM3NeT \cite{KM3NeT_Design}. In both cases, the muon's direction is measured at its crossing through the instrumented volume, which is then utilized to infer its origin or the origin of the parent neutrino. 
...
\begin{figure*}
    ...
    the angular resolution of ARCA (part of KM3NeT designed for high-energetic neutrino search) taken from \cite{KM3NeT_Resolution2016, KM3NeT_Resolution2021} are 
