...
PROPOSAL. Also, the losses are divided into continuous und stochastic 
energy losses by an relative energy cut. 
\begin{itemize}
    \item maybe use a table for the cross-section comparison?
    \item electron pair production: Kokoulin-Petrukhin [11], deflection [12]
    \item bremsstrahlung: 1. BezrukovandBugaev[9], 2.Kelner, Kokoulin andPetrukhin
    [4], deflection [12] 
    \item inelastic scattering: Bezrukov and Bugaev [16], deflection GEANT4
    \item ionization: treated as stochastic process, but no deflection
    \item scattering: gaussian approx
\end{itemize}
