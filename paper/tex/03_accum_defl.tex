...
\begin{figure}
    ...
    \cite{comparison_MUSIC_GEANT4_2009}. \textcolor{red}{schreibe Highland und Moliére groß im Plot}}
...
for point-source-analysis of $E_{\text{f}} \approx \SI{500}{\giga\electronvolt} - \SI{5}{\tera\electronvolt}$ \textcolor{red}{wo kommen die zahlen her? ist das quatsch?}
