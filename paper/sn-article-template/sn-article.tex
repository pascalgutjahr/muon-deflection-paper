...
is treated as a stochastic energy loss. An energy loss $E_{\mathrm{loss}} < E_{\text{loss,min}}$ forms an integrated 
...
$x$.}{for the 
accumulated deflection angle $\theta_{\text{acc}}$ and the lateral displacement
$x$. Four different settings are studied in PROPOSAL.} The deflection angles are 
...
\pascalcomment{SFB 876 and SFB 1491}
