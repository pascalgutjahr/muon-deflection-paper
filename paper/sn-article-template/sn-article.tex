...
\title[Article Title]{Simulation of theoretical deflection uncertainty on directional 
...
\author[2]{\fnm{Alexander} \sur{Sandrock}}\email{MISSING}

\author[3]{\fnm{Jan} \sur{Soedingrekso}}\email{MISSING}
