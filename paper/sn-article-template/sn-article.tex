...
The deflection per interaction extends over several 
orders of magnitude with $\theta \in [\SI{e-9}{\degree},\, \SI{1}{\degree}]$ 
for muon energies $\SI{1}{\tera\electronvolt} < E < \SI{1}{\peta\electronvolt}$ 
and is rather negligible for the directional reconstruction. \pascaledit{The deflection increases as 
...
dependence of the final muon energy. Furthermore, \pascalreplace{the deflections are compared to the results 
...
this energy cut, in the propagation the next significant energy loss with $E_{\mathrm{loss}} > E_{\text{loss,min}}$ 
...
\pascalcomment{Was passiert bei $E_{\mathrm{loss}} = E_{\text{loss,min}}$? stoch oder cont?} 
