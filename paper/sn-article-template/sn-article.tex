...
Furthermore, an agreement is obtained in comparison with the simulation tools MUSIC and Geant4 and the results are compared to two 
different muon deflection measurements.}
