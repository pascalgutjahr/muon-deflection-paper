...
deflection of muons along a propagation path in dense media is simulated with the 
...
muon energy for the energy range studied here. 
Furthermore, an agreement is obtained in comparison with the simulation tools MUSIC and Geant4.}

\keywords{neutrino astronomy, neutrino source search, angular resolution}
...
\begin{figure}
    ...
    the normalized counts in dependence of the projected scattering angle $\theta_{\mathrm{y}}$ in radians. At small angles, deflections are  
    ...
    There is no significant difference between the two energy cuts.}
